codeunit 82580 ADLSESetupLocal implements ADLSESetup
{
    var
    ...
    var
        ADLSESetupSpecCompany: Record "ADLSE Setup Spec Company";
        RecRef: RecordRef;
        FRef: FieldRef;
    begin
        ADLSESetupSpecCompany.Get();
        RecRef := ADLSESetupSpecCompany.RecordId.GetRecord();
    ...
    var
        Rec: Record "ADLSE Setup Spec Company";
    begin
        Rec.Get();
    ...
    var
        ADLSESetupRec: Record "ADLSE Setup Spec Company";
    begin
        ADLSESetupRec.Get();
